 ...
 */
public class ControllerQwirkleKey extends ControllerKey implements EventHandler<KeyEvent> {

    public ControllerQwirkleKey(Model model, View view, Controller control) {
